...
actions = np.array(['Choti hay', 'Rray', 'Jeem'])
...
model.load_weights(LOCAL_PATH + '/action.h5')
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                if hand_sign_id == "No Application":  # Point gesture
...
@main.route('/openstatic')
def openstatic():
    return render_template('static.html')

@main.route('/opendynamic')
def opendynamic():
...
@main.route('/groupinfo')
def groupinfo():
    return render_template('Groupinfo.html') 

@main.route('/videostatic')
def getstatic():
    return Response(static_frames(), mimetype='multipart/x-mixed-replace; boundary=frame')         

@main.route('/videodynamic')
def getdynamic():
    return Response(dynamic_frames(), mimetype='multipart/x-mixed-replace; boundary=frame')  
